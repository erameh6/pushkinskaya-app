...
app.get('/api/signatures', (req, res) => {
  res.json(SITES.map(s => ({
    ...
    embedding: (signatures[s.id] && signatures[s.id].embedding) || null
  })));
});
